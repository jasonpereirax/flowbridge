                  ...
                  <MacroNodeCard 
                    ...
                    onDragStart={(id, x, y) => {
                      ...
                      const onMove = (e: PointerEvent) => {
                        ...
                        store.moveNode(id, { x: startNodePos.x + delta.x, y: startNodePos.y + delta.y })
                      }
                      const onUp = () => {
                  ...
                  <ScreenNodeCard 
                    ...
                    onDragStart={(id, x, y) => {
                      ...
                      const onMove = (e: PointerEvent) => {
                        const currentPos = screenToCanvas(e.clientX, e.clientY)
                        const delta = { x: currentPos.x - startPos.x, y: currentPos.y - startPos.y }
                        store.moveScreen(journey.id, activeFlow.id, id, { x: startScreenPos.x + delta.x, y: startScreenPos.y + delta.y })
                      }
                      const onUp = () => {
                        window.removeEventListener('pointermove', onMove)
                        window.removeEventListener('pointerup', onUp)
