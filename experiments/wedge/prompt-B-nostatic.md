...
SEMANTIC CONTEXT:
- Purpose: The "Selected Clients" section of a portfolio landing page that lists the
  designer's client projects.
- Route: this section is part of the home page at / (app/page.tsx).
...
- Notes: Use Tailwind; avoid duplicating long utility class strings across the rows —
  keep them in the single <ProjectRow>. Strict TS: type the data and the component props explicitly.
