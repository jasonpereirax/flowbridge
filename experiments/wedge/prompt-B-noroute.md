...
- Rendering: render it as a Server Component — do NOT add "use client" (there is no
  interactivity beyond links).
...
Use this context to extract the repeated pattern into a reusable component + typed data,
and wire the links accurately.
