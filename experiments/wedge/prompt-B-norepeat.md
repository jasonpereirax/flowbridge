...
- State / notes: no loading / error / empty states (static content). Use Tailwind. Strict
  TS: type the data explicitly.

Use this context to place files correctly and wire the links accurately.
